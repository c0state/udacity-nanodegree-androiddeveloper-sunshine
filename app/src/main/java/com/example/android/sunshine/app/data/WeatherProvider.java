...
public class WeatherProvider extends ContentProvider {
    ...
    /*
        ...
        match each URI to the WEATHER, MATCHERCONTENT_TYPE_WEATHER_WITH_LOCATION, CONTENT_TYPE_WEATHER_WITH_LOCATION_AND_DATE,
    ...
    static UriMatcher buildUriMatcher() {
        ...
        sURIMatcher.addURI(WeatherContract.CONTENT_AUTHORITY,
                WeatherContract.WeatherEntry.MATCHER_WEATHER_WITH_LOCATION,
                WeatherProvider.WEATHER_WITH_LOCATION);
        sURIMatcher.addURI(WeatherContract.CONTENT_AUTHORITY,
                WeatherContract.WeatherEntry.MATCHER_WEATHER_WITH_LOCATION_AND_DATE,
                WeatherProvider.WEATHER_WITH_LOCATION_AND_DATE);
        sURIMatcher.addURI(WeatherContract.CONTENT_AUTHORITY,
                WeatherContract.WeatherEntry.MATCHER_WEATHER,
                WeatherProvider.WEATHER);
        sURIMatcher.addURI(WeatherContract.CONTENT_AUTHORITY,
                WeatherContract.WeatherEntry.MATCHER_LOCATION,
    ...
    public int delete(Uri uri, String whereClause, String[] whereClauseArgs) {
        ...
        switch (match) {
            ...
            default:
                throw new UnsupportedOperationException("Unknown uri for deletion: " + uri);
        }
    ...
    @Override
    public int update(
            Uri uri, ContentValues values, String updateClause, String[] updateClauseArgs) {
